<template>
  <div class="flex justify-between w-full my-5">
    <button
      ...
      class="
        rounded-xl hover:bg-gray-100 flex flex-col justify-center items-center
        p-5 w-28 cursor-pointer focus:outline-none"
    >
      <div>
    ...
    >
      <div>
        <img class="w-full" src="../../assets/images/lamp.png" alt="idea">
      </div>
