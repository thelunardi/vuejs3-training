  ...
  <div class="flex justify-center w-full pb-20">
    <div class="w-4/5 max-w-6xl py-10 grid grid-cols-4 gap-2">
      ...
      <div class="px-10 pt-20 col-span-3">
        ...
        <p
          v-if="!state.feedbacks.length && !state.isLoading && state.isLoadingFeedbacks && !state.hasErros"
          class="text-lg text-center text-gray-800 font-regular"
        >
...
import FeedbackCard from '@/views/Feedbacks/FeedbackCard'
import FeedbackCardLoading from '@/views/Feedbacks/FeedbackCardLoading'

export default {
  components: { FeedbackCard, FeedbackCardLoading, FiltersLoading, Filters, HeaderLogged },
  setup () {
